...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">Thành viên: <?php echo $users['user_name'];?></h1>
		</div>
	</div><!--/.row-->
	<div class="row">
			<div class="col-lg-12">
					...
					<div class="panel-body">
						...
						<form role="form" method="post" enctype="multipart/form-data">
							<div class="form-group">
								<label>Họ & Tên</label>
								<input type="text" name="user_name" class="form-control" value="<?php echo $users['user_name']; ?>" placeholder="">
