                ...
                <div class="panel-body">
                    <table 
                        ...
                        <?php if(mysqli_num_rows($resultAll) > 0) { 
                            ...
                            ?>
                            <tr>
                                <td style=""><?php echo $users['user_id']; ?></td>
                                <td style=""><?php echo $users['user_name'];?></td>
                                ...
                                <td class="form-group">
                                <a href="index.php?page=edit_user&user_id=<?php echo $users['user_id']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                        <a onclick="return confirmDel();" href="modules/user/del_user.php?user_id=<?php echo $users['user_id']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                                    </td>
                            </tr> <?php 
                        }}?>
